...
<div class="content-block" style="font-family: sans-serif;line-height: 130%;color: #FFF;">
    ...
    <br>
    {{ config('app.sitename') }} – сайт <strong>рулетка CS GO</strong> для бомжей и новичков которые любят <strong>халяву</strong>. Для того чтобы стать участником игры Вы просто должны авторизоваться на сайте через ваш аккаунт в Steam. При Авторизации мы получаем только данные от вашего профиля. Наша рулетке необходима только вашу ссылку на обмен чтобы отправить вам ваш выигрыш. Затем Вы спокойно можете вносить любой депозит как карточками, так и вещами CS GO.
    <br><br>
    На нашей мы не ограничиваем игроков максимальной суммой депозита, Вы можете внести {{ config('mod_game.max_items') }} предметов, но их общая стоимость увеличивает ваши шансы на победу. Каждый игрок может внести как большое, так и малое количество вещей, но от суммы внесенного вами депозита зависят ваши шансы на победу относительно других игроков.
    <br><br>
    Играя на нашей лотереи <strong>CS GO для бомжей</strong> и <strong>новичков</strong> с <strong>минимальной ставкой {{ config('mod_game.min_price') }} рубль</strong>, Вы способны испытать свою удачу и проверить честность игры и получить крупную сумму без затруднений благодаря нашей открытой и прозрачной системе выбора победителя. Обмен с выигранными вещами отправляется нашими Steam ботами автоматически после завершения игры. 
    <br><br>
    Если у вас возникли вопросы или проблемы получения выигрыша на сайте, Вы всегда можете обратиться в нашу отзывчивую поддержку для получения моментального ответа на ваш запрос. Рулетка CS GO для бомжей и новичков с минимальной ставкой {{ config('mod_game.min_price') }} рубль моментально решает все вопросы и проблеы связанные с непредвиденными обстоятельставми!
    <br><br>
    {{ config('app.sitename') }} – дает возможность игрокам вносить до {{ config('mod_game.game_items') }} вещей в каждую игру. При этом не более {{ config('mod_game.max_items') }} вещей от каждого игрока. Время одной игры на рулетке занимает ~ 2 минуты. По ходу игры каждый игрок способен без затруднений внести вещи для принятия участия в розыгрыше. 
    <br><br>
