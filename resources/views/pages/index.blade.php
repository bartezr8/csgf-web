...
<div class="content-block" style="font-family: sans-serif;line-height: 130%;color: #FFF;">
    ...
    <br><br>
    {{ config('app.sitename') }} – дает возможность игрокам вносить до 100 вещей в каждую игру. При этом не более 20 вещей от каждого игрока. Время одной игры на рулетке занимает 2 минуты. По ходу игры каждый игрок способен без затруднений внести вещи для принятия участия в розыгрыше. 
    <br><br>
