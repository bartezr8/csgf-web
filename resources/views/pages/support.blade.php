...
@section('content')
    <div class="faq-page">
        ...
        <div class="page-content">
            ...
            <div class="page-main-block">
                <div class="page-mini-title">ОШИБКА ОТПРАВКИ!</div>
                <div class="page-block">
                    Если у вашего трейда в <a href="/history" target="_blank">истории</a> статус отправки "Ошибка отправки" то такой трейд будет переотправлятся каждые 15 мин.<br>
                    Максимальное число переотправок - 5 раз. Если вещи не приходят больше 30 мин значит проблема с вашим аккаунтом или данными!<br>
                    В среднем 5 раз трейд переотправляется за 1 час. Если вы не успеете исправить проблему - выигрыш анулируется.<br>
                    Поддержка не обязана отправлять вам трейд если вы не смогли обеспечить правильные данные для принятия обмена.<br>
                </div>
            </div>
            <div class="page-main-block">
            ...
            <div class="page-main-block">
                <div class="page-mini-title">Пропал баланс.</div>
                <div class="page-block">
                    Гипотетически в теории возможно непредвиденное обнуление баланса, но тогда оно будет у всех.<br>
                    В основном с таким обращением пишут обманщики проигравшие все деньги на костях и думающие что<br>
                    их не отследят. Так же если вы каким либо образом накручивали средства на сайте или обманывали<br>
                    людей, администрация имеет право забрать у вас полную сумму или удалить аккаунт.
                </div>
            </div>
